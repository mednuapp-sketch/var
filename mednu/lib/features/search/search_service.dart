...
class SearchService {
  ...
  static const _services = <SearchResult>[
    ...
    SearchResult(
      ...
      category: SearchCategory.service,
      keywords: ['ambulance', '108', 'emergency transport', 'urgent transport', 'ems'],
      badge: '24/7',
    ),
    SearchResult(
      id: 'diagnostics',
      title: 'Diagnostics & Lab Tests',
      subtitle: 'Blood tests, X-Ray, MRI and more',
      route: AppRoutes.diagnostics,
      icon: Icons.science_rounded,
      color: Color(0xFF0097A7),
      category: SearchCategory.service,
      keywords: ['diagnostic', 'lab', 'test', 'blood test', 'xray', 'mri', 'scan', 'pathology', 'sample'],
    ),
    SearchResult(
      id: 'home_sample',
      title: 'Home Sample Collection',
      subtitle: 'Lab tests collected at your doorstep',
      route: AppRoutes.diagnostics,
      icon: Icons.home_rounded,
      color: Color(0xFF00897B),
      category: SearchCategory.service,
      keywords: ['home sample', 'doorstep', 'at home test', 'home collection', 'home visit'],
      badge: 'At Home',
    ),
    SearchResult(
      id: 'physio',
    ...
    SearchResult(
      ...
      color: Color(0xFFB71C1C),
      category: SearchCategory.service,
      keywords: ['emergency', 'urgent', 'sos', 'critical', 'accident', 'heart attack', '112', 'first aid'],
      badge: '24/7',
    ),
    SearchResult(
      id: 'pregnancy',
