...
/// — same visual language as the Caregiver module's Assigned Visits screen.
class PhysioSessionsScreen extends ConsumerStatefulWidget {
  const PhysioSessionsScreen({super.key});

  @override
  ConsumerState<PhysioSessionsScreen> createState() => _PhysioSessionsScreenState();
}

class _PhysioSessionsScreenState extends ConsumerState<PhysioSessionsScreen>
  ...
  Widget build(BuildContext context) {
    return SharedAppShell(
      currentRoute: AppRoutes.physioSessions,
      title: 'Sessions',
      body: Column(
        children: [
          Container(
...
class _SessionTimeline extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final sessions =
        upcoming ? ref.watch(upcomingPhysioSessionsProvider) : ref.watch(physioSessionHistoryProvider);
