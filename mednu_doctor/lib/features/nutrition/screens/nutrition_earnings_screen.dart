...
/// Earnings — hero total + recent completed appointments. Unlike the
/// ledger-backed Physiotherapy/Counselling earnings screens, this is a
/// client-side aggregation over `nutrition_appointments.fee` (there is no
/// Cloud Function mirror for Nutrition) via `walletSummaryProvider`, which
/// resolves to `NutritionAppointmentWalletRepository` for this role.
